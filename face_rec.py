...
# ✅ Redis Connection - reads from environment or st.secrets
def get_redis_connection():
    try:
        ...
        load_dotenv()
        host = os.environ.get("REDIS_HOST", "redis-13725.c14.us-east-1-3.ec2.cloud.redislabs.com")
        port = int(os.environ.get("REDIS_PORT", 13725))
        password = os.environ.get("REDIS_PASSWORD", "9i4nKqNjtqWbwwwAJEm1qfvVCoUn5FjX")
